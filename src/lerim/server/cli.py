    ...
    try:
        if subaction == "add":
            result = api_skill_target_add(
                ...
                update_mode=getattr(args, "mode", "review"),
            )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    target_add = target_sub.add_parser("add", formatter_class=_F, help="Register a skill or instruction path")
    ...
    target_add.add_argument(
        ...
        default="review",
        help="Update mode. Default: review.",
    )
    target_list = target_sub.add_parser("list", formatter_class=_F, help="List registered targets")
    target_list.add_argument("--json", action="store_true", default=argparse.SUPPRESS, help="Emit machine-readable JSON.")
    target_show = target_sub.add_parser("show", formatter_class=_F, help="Show one registered target")
    ...
    proposal_list = proposal_sub.add_parser("list", formatter_class=_F, help="List proposals")
    ...
    proposal_show = proposal_sub.add_parser("show", formatter_class=_F, help="Show one proposal")
    proposal_show.add_argument("proposal", help="Proposal id.")
    proposal_apply = proposal_sub.add_parser("apply", formatter_class=_F, help="Apply one proposal")
    proposal_apply.add_argument("proposal", help="Proposal id.")
    proposal_reject = proposal_sub.add_parser("reject", formatter_class=_F, help="Reject one proposal")
