...
5. `agents/tools.py` for the semantic agent tool surface (`trace_read`, `list_records`, `search_records`, `fetch_records`, `create_record`, `update_record`, `archive_record`, `supersede_record`, `context_query`, `note`, `prune`).
