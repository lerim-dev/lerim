...
from lerim.agents.context_graph.graph import run_context_graph_graph
...
def run_context_graph(
    *,
    ...
    """Run the BAML and LangGraph context-graph agent on one project scope."""
    ...
    with mlflow_span(
        ...
        final_state = run_context_graph_graph(
            context_db_path=resolved_context_db_path,
            project_identity=project_identity,
            session_id=session_id,
            config=cfg,
