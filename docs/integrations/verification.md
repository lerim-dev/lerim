...
| Opt-in local stdio trace-submit extraction probe | A synthetic submitted trace can run through the BAML/LangGraph extraction path and create records. | Proof that an external installed client submitted an organic trace. |
